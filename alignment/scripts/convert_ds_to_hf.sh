...
# Example: CONVERT_HF=1 ./scripts/convert_ds_to_hf.sh logs/tcc_qwen_alignment_20260104_162651

INPUT_ARG=${1:-"tcc_qwen_alignment_"}
MODEL_PATH=${2:-"/mnt/data/checkpoint/ethanchen/Qwen3/Qwen3-VL-Embedding-8B"}
