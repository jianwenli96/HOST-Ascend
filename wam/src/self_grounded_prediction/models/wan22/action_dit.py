...
class ActionDiT(nn.Module):
    ...
    # Substrings: matched anywhere in the key (handles nested paths like blocks.0.task_video_cross_attn.*)
    ACTION_BACKBONE_SKIP_SUBSTRINGS = ("task_video_cross_attn.", "norm_task_video.", "gate_proj.")
    ...
    def backbone_key_set(cls, keys) -> set[str]:
        return {
            ...
            and not any(substr in key for substr in cls.ACTION_BACKBONE_SKIP_SUBSTRINGS)
        }
